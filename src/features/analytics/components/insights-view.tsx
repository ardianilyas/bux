...
import { PLAN_TYPES } from "@/features/billing/lib/billing-constants";
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="relative">
        {!isPro && (
          <div className="absolute inset-0 z-50 bg-background/60 backdrop-blur-sm flex flex-col items-center justify-center p-6 text-center select-none rounded-lg border border-border/50">
            <div className="bg-primary/10 p-4 rounded-full mb-4 ring-1 ring-primary/20 shadow-lg shadow-primary/5">
              <Lock className="h-8 w-8 text-primary" />
            </div>
            <h3 className="text-xl font-bold text-foreground mb-2">Unlock Advanced Insights</h3>
            <p className="text-muted-foreground mb-6 max-w-sm">
              Upgrade to the Pro plan to access detailed spending trends, category breakdowns, and top merchant analytics.
            </p>
            <Button onClick={() => router.push("/dashboard/billing")} size="lg" className="shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all">
              Upgrade to Pro <TrendingUp className="ml-2 h-4 w-4" />
            </Button>
          </div>
        )}
